...
func main() {
	testCases := []struct {
		...
		{nums1: []int{4,1,2}, nums2: []int{1,3,4,2}, output: []int{-1,3,-1}},
		{nums1: []int{2,4}, nums2: []int{1,2,3,4}, output: []int{3,-1}},
		{nums1: []int{1,3,5,2,4}, nums2: []int{6,5,4,3,2,1,7}, output: []int{7,7,7,7,7}},
	}

	for _, tc := range testCases {
		fmt.Println("inputs =", tc.nums1, tc.nums2, "result =", nextGreaterElement(tc.nums1, tc.nums2), "expected output =", tc.output)
	}
}
